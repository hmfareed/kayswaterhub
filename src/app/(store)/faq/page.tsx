...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-24">
      {/* ── Hero Section ────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-blue-950 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          ...
          <div className="max-w-md mx-auto relative pt-4">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white/10 border border-white/20 text-white placeholder:text-slate-400 text-sm font-medium outline-hidden focus:ring-2 focus:ring-blue-500 backdrop-blur-md transition-all shadow-lg"
            />
          </div>
        </div>
      </section>
        ...
        <div className="mt-6 space-y-3">
          {filteredFaqs.length === 0 ? (
            <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 space-y-3">
              ...
              <p className="text-xs text-slate-500">Try adjusting your search terms or view all categories.</p>
              <button
