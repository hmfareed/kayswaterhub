      ...
      <main className="flex-1 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="p-6 rounded-2xl bg-blue-50/60 border border-blue-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Direct hotline for fast orders & queries</p>
                  <div className="mt-2 space-y-1">
                    <a href="tel:+233209878744" className="block text-sm font-extrabold text-blue-600 hover:underline">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-600 hover:text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-full mt-1"
                    >
              ...
              <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">For corporate inquiries and partnerships</p>
                  <a href="mailto:support@kayspacks.com" className="block text-sm font-semibold text-slate-800 hover:text-blue-600 mt-1">
              ...
              <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-1">Monday – Saturday: 6:30 AM – 8:00 PM</p>
                  <p className="text-xs text-slate-600">Sunday: 8:00 AM – 6:00 PM</p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-base">Delivery Coverage</h3>
            ...
            {/* Right: Message Form */}
            <div className="lg:col-span-7 bg-slate-50 p-8 rounded-3xl border border-slate-100">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-sm focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600"
                      />
                    </div>
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-3.5 rounded-xl shadow-md transition-colors"
                  >
