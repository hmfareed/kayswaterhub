  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 selection:bg-blue-500 selection:text-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pb-24 lg:pb-12">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-xs grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-12">
          ...
          <div className="lg:col-span-6 flex flex-col-reverse sm:flex-row gap-4 items-center sm:items-start">
            ...
            <div className="flex sm:flex-col gap-3">
              {(product.images && product.images.length > 0 ? product.images : [null]).map((imgSrc, idx) => (
                <button
                  ...
                  className={`w-16 h-20 rounded-xl bg-slate-50 p-2 flex items-center justify-center border transition-all overflow-hidden ${
            ...
            <div className="flex-1 w-full h-80 sm:h-96 bg-white rounded-2xl flex items-center justify-center p-6 border border-slate-100 relative overflow-hidden">
              ...
              <button
                ...
                className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white shadow-xs border border-slate-100 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-colors"
                aria-label="Wishlist"
              >
          ...
          <div className="lg:col-span-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center border border-slate-200 rounded-xl bg-slate-50 px-2 py-1.5">
                  <button
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-700 hover:bg-white transition-colors font-bold"
                    aria-label="Decrease"
                  >
                    <Minus className="w-4 h-4" />
                  </button>
                  <span className="w-12 text-center font-black text-slate-900 text-base">
                    {quantity}
                  </span>
                  <button
                ...
                <div className="text-sm font-bold text-slate-600">
                  Total: <span className="text-blue-600 font-black text-base">{formatCurrency(totalPrice)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl font-bold text-sm bg-white hover:bg-slate-50 text-blue-600 border-2 border-blue-600 transition-all text-center"
              >
                Buy Now
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-100 text-center">
              <div className="p-2 space-y-1">
                ...
                <h3 className="font-bold text-[11px] text-slate-900">100% Original</h3>
                <p className="text-[10px] text-slate-500">Authentic & sealed</p>
              </div>

              <div className="p-2 space-y-1">
                <CreditCard className="w-5 h-5 text-emerald-600 mx-auto" />
                <h3 className="font-bold text-[11px] text-slate-900">Secure Payment</h3>
                <p className="text-[10px] text-slate-500">100% safe payments</p>
              </div>

              <div className="p-2 space-y-1">
                <Truck className="w-5 h-5 text-indigo-600 mx-auto" />
                <h3 className="font-bold text-[11px] text-slate-900">Fast Delivery</h3>
                <p className="text-[10px] text-slate-500">To your doorstep</p>
              </div>
            </div>
          </div>
        </div>
